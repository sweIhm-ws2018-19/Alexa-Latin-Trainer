...
public class NextWordIntentHandler implements RequestHandler{
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        persistentAttributes.put("highscore", 900);
        attributesManager.setPersistentAttributes(persistentAttributes);
        attributesManager.savePersistentAttributes();
        String savedMode = (String) persistentAttributes.get("modus");
        String savedDir = (String) persistentAttributes.get("richtung");
        int savedChapter = (Integer) persistentAttributes.get("kapitel");
        int savedHighscore = (Integer) persistentAttributes.get("highscore");
